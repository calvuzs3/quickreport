...
class AppSettingsRepositoryImpl @Inject constructor(
    ...
    override suspend fun setHomeShowCheckUpStats(value: Boolean) =
        appSettingsDataStore.setHomeShowCheckUpStats(value)
    ...
    override suspend fun setHomeShowRecentCheckUps(value: Boolean) =
        appSettingsDataStore.setHomeShowRecentCheckUps(value)
