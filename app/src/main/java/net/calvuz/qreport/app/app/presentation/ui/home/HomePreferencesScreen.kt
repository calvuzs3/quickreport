...
fun HomePreferencesScreen(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        Column(
            ...
            SettingsSection(title = stringResource(R.string.home_preferences_section_checkups)) {
                SettingsSwitchItem(
                    title = stringResource(R.string.home_preferences_show_checkup_stats_title),
                    subtitle = stringResource(R.string.home_preferences_show_checkup_stats_subtitle),
                    icon = CheckupPkg.icon,
                    checked = preferences.showCheckUpStats,
                    onCheckedChange = viewModel::setShowCheckUpStats
                )
                SettingsSwitchItem(
                    title = stringResource(R.string.home_preferences_show_recent_checkups_title),
                    subtitle = stringResource(R.string.home_preferences_show_recent_checkups_subtitle),
                    icon = Icons.Default.PersonSearch,
                    checked = preferences.showRecentCheckUps,
                    onCheckedChange = viewModel::setShowRecentCheckUps
                )
            }
